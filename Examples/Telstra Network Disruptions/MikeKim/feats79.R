...
feat4 <- feat4[ ,.(
  logn1 = fitdistr(COUNT,"log-normal")$estimate[1], #tried max,median, mad (worse), iqr, skewness, entropy
  logn2 = fitdistr(COUNT,"log-normal")$estimate[2]
), id]
...
write.csv(feat4, "/home/mikeskim/Desktop/kaggle/telstra/features/feats79.csv", quote=FALSE, row.names = FALSE)