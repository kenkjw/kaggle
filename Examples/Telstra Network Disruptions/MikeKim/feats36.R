...
tmp6 <- tmp5[ ,.(
  E3 = fitdistr(E2,'log-normal')$estimate[1],
  E4 = fitdistr(E2,'log-normal')$estimate[2]
), id]
...
write.csv(tmp6, "/home/mikeskim/Desktop/kaggle/telstra/features/feats36.csv", quote=FALSE, row.names = FALSE)
